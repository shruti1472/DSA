...
class StockSpanner{
public:
    // vector<int>arr;             //this is for brute force approach
    ...
    int next(int price){
        ...
        //brute force approach can take up to O(n*2) time complexity
    //     arr.push_back(price);
    //     int span=1;
    ...
    //optimal approach take upto linear time complexity
     int span=1;
